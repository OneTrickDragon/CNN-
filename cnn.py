...
class ConvNet(nn.Module):
    ...
    def forward(self, x):
        output = self.maxpool1(self.relu(self.bn1(self.conv1(x))))
        output = self.maxpool2(self.relu2(self.bn2(self.conv2(x))))
        output = self.maxpool3(self.relu3(self.bn3(self.conv3(x))))
